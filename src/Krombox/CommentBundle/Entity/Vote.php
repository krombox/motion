...
namespace Krombox\CommentBundle\Entity;
...
class Vote extends BaseVote implements SignedVoteInterface
{
     ...
     *
     * @var Comment
     * @ORM\ManyToOne(targetEntity="Krombox\CommentBundle\Entity\Comment")
     */
    protected $comment;
     ...
     * Author of the vote
     *
     * @ORM\ManyToOne(targetEntity="Krombox\UserBundle\Entity\User")
     * @var User
     */
    protected $voter;
