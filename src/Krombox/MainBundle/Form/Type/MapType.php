...
class MapType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add($options['address_name'], $options['address_type'], array_merge($options['options'], $options['address_options']))
        ;
    }
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            ...
            'address_options' => array(),    // the options for just the lng field
            'lat_name'       => 'lat',   // the name of the lat field
            'lng_name'       => 'lng',   // the name of the lng field
            'address_name'       => 'address',   // the name of the lat field
